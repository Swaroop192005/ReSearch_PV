...
def power_figs():
    ...
    if not (have(MONO) and have(NIST)): print("[skip] expected site names not found; edit MONO/NIST at top"); return None
    rows=[]
    ...
    fig.colorbar(im,ax=ax,shrink=0.8); save(fig,"fig3_matrix.png")
...
def transfer_figs(ctx):
    ...
    ax.set_title("Few-shot transfer-learning recovery"); ax.grid(alpha=0.3); save(fig,"fig4_recovery.png")
...
def fault_figs():
    ...
    fig.suptitle("Cross-mode fault-detection confusion matrices"); save(fig,"fig8_confusion.png")
